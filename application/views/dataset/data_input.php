    ...
    <div class="col-lg-12"><br />
        ...
        <ol class="breadcrumb">
            <li><a href="<?php echo base_url('dataset'); ?>">Dataset</a></li>
			 <li><a href="<?php echo base_url('datasett'); ?>">Dataset Kedua</a></li>
...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="panel panel-default">
            ...
            <?php echo form_open('dataset/insert', array('class' => 'form-horizontal', 'id' => 'jvalidate')) ?>
                ...
                <div class="form-group">
                    <div class="col-sm-6">
                        <div class="btn-group pull-left">
                            <?php echo anchor('dataset', 'Cancel', array('class' => 'btn btn-danger btn-sm')); ?>
                        </div>
                    </div>
                    <div class="col-sm-6">
