...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="panel panel-default">
            ...
            <?php echo form_open_multipart('klasifikasii/klasifikasi', array('class' => 'form-horizontal')) ?>
			...
			<div class="form-group">
                ...
                <div class="col-sm-6">
                        <div class="btn-group pull-right">
                            <input type="submit" name="tblklasifikasi" value="Klasifikasi" class="btn btn-success btn-sm">
                        </div>
                </div>
