...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="<?= base_url('assetss/assets/css/jquery.toast.css') ?>">
    </head>
            ...
            <aside class="main-sidebar">
                <section class="sidebar">
                    <ul class="sidebar-menu">
						...
						<li class="treeview">
                            <a>
                                <i class="fa fa-database fa-fw"></i> <span>Data Akhir</span>
                                <span class="pull-right-container">
                                    <i class="fa fa-angle-left pull-right"></i>
                                </span>
                            </a>
                            <ul class="treeview-menu menu-open" style="display: none;">
                                ...
                                <li><a href="<?= base_url('klasifikasi') ?>"><i class="fa fa-circle-o"></i> Klasifikasi </a></li>
								 ...
								 <li><a href="<?= base_url('Akhir_data') ?>"><i class="fa fa-pencil fa-fw"></i> Data Grafik </a></li>
                            </ul>
                        </li>
                       ...
                       <li class="treeview">
                        ...
                        <li class="treeview">
                            <a>
                                <i class="fa fa-crosshairs"></i> <span>Kriteria</span>
                                <span class="pull-right-container">
                                    <i class="fa fa-angle-left pull-right"></i>
                                </span>
                            </a>
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu menu-open" style="display: none;">
								...
								<li><a href="<?= base_url('Data_sub') ?>"><i class="fa fa-circle-o"></i> Data Subkriteria</a></li>
                            </ul>
                        </li>
                        <li class="treeview active">
                            <a>
                                <i class="fa fa-mortar-board"></i> <span>Pembobotan Data</span>
                                <span class="pull-right-container">
                                    <i class="fa fa-angle-left pull-right"></i>
                                </span>
                            </a>
