...
<html>
    <head>
        ...
        <link rel="stylesheet" href="<?= base_url('assets/assets/skins/_all-skins.min.css') ?>">
        <link rel="stylesheet" type="text/css" href="<?= base_url('assets/assets/css/jquery.toast.css') ?>">
    </head>
